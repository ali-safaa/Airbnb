...
function InfoCard(props) {
    return (
        <div className="flex mt-3 border-b mb-2 hover:opacity-60 cursor-pointer hover:shadow-lg transition duration-300 ease-in-out">
           ...
           <div className="ml-2 flex-grow">
               ...
               <p className="text-xs text-gray-500 mt-2 sm:text-sm">{props.bio}</p>
